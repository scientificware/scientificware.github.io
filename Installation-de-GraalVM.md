...
- Pour compiler en mode natif :
  ...
  - Pour compléter la variable PATH avec le chemin vers GraalVM : `setx /M PATH "C:\Program Files\GraalVM\graalvm-ce-java11-20.3.0\bin;%PATH%"`
  - Pour afficher le contenu de la variable est vérifier l'ajout du chemin : `echo %PATH%`
  - Pour définir la variable d'environnement JAVA_HOME `setx /M JAVA_HOME "C:\Program Files\GraalVM\graalvm-ce-java11-20.3.0"`
